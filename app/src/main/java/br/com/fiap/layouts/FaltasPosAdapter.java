...
public class FaltasPosAdapter
  extends BaseAdapter
{
  private List<FaltaPosBean> faltas;
  private ViewHolder holder;
  private LayoutInflater mInflater;
  
  public FaltasPosAdapter(Context paramContext, List<FaltaPosBean> paramList)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    for (;;)
    {
      paramViewGroup = (FaltaPosBean)this.faltas.get(paramInt);
...
/* Location:              C:\Users\HP\Desktop\Nova pasta\dex2jar-2.0\fiap-dex2jar.jar!\br\com\fiap\layouts\FaltasPosAdapter.class
