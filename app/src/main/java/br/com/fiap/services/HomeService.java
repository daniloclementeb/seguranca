...
{
  public List<BannerBean> banners(String paramString1, String paramString2)
  {
    localArrayList = new ArrayList();
    try
    {
      Object localObject = new SoapObject("http://tempuri.org/", "Banner");
      ...
      new HttpTransportSE("http://www2.fiap.com.br/smaiw/app.asmx").call("http://tempuri.org/Banner", paramString1);
      paramString1 = new JSONArray(new JSONObject(((SoapPrimitive)paramString1.getResponse()).toString()).getString("ListaBanner"));
      int i = 0;
      for (;;)
      {
        ...
        localObject = new BannerBean();
        ((BannerBean)localObject).setUrl(paramString2.getString("UrlImagem"));
        ((BannerBean)localObject).setUrltarget(paramString2.getString("UrlTarget"));
  ...
  public List<CalendarioGraduacaoBean> horarios(String paramString1, String paramString2, String paramString3, String paramString4)
  {
    ...
    try
    {
      ...
      paramString1 = new JSONArray(new JSONObject(((SoapPrimitive)paramString1.getResponse()).toString()).getString("ListaDiaSemana"));
      int i = 0;
      int j;
      for (;;)
      {
  ...
  public List<CalendarioPosGraduacaoBean> horariosPos(String paramString1, String paramString2, String paramString3, String paramString4)
  {
    ...
    try
    {
      ...
      ((SoapObject)localObject).addProperty("stTipo", "H");
...
/* Location:              C:\Users\HP\Desktop\Nova pasta\dex2jar-2.0\fiap-dex2jar.jar!\br\com\fiap\services\HomeService.class
