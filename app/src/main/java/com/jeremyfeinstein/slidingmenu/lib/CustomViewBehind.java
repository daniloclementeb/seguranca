  ...
  extends ViewGroup
{
  ...
  public void drawSelector(View paramView, Canvas paramCanvas, float paramFloat)
  {
    ...
    while ((this.mSelectorDrawable == null) || (this.mSelectedView == null) || (!((String)this.mSelectedView.getTag(R.id.selected_view)).equals("CustomViewBehindSelectedView"))) {
      return;
    }
    paramCanvas.save();
...
/* Location:              C:\Users\HP\Desktop\Nova pasta\dex2jar-2.0\fiap-dex2jar.jar!\com\jeremyfeinstein\slidingmenu\lib\CustomViewBehind.class
