  ...
  implements CollapsibleActionView
{
  ...
  private void adjustDropDownSizeAndPosition()
  {
    ...
    for (int i = localResources.getDimensionPixelSize(R.dimen.abs__dropdownitem_icon_width) + localResources.getDimensionPixelSize(R.dimen.abs__dropdownitem_text_padding_left);; i = 0)
    {
      ...
      this.mQueryTextView.setDropDownWidth(this.mDropDownAnchor.getWidth() + localRect.left + localRect.right + i - j);
      return;
    }
  }
  ...
  private Intent createIntentFromSuggestion(Cursor paramCursor, int paramInt, String paramString)
  {
    ...
    if (localObject1 != null)
    {
      ...
      if (str != null)
      {
        localObject3 = localObject1 + "/" + Uri.encode(str);
        break label220;
        for (;;)
        {
...
/* Location:              C:\Users\HP\Desktop\Nova pasta\dex2jar-2.0\fiap-dex2jar.jar!\com\actionbarsherlock\widget\SearchView.class
