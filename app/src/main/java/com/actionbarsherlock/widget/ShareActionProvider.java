  ...
  extends ActionProvider
{
  ...
  public void onPrepareSubMenu(SubMenu paramSubMenu)
  {
    ...
    for (;;)
    {
      ...
      ResolveInfo localResolveInfo = localActivityChooserModel.getActivity(i);
      paramSubMenu.add(0, i, i, localResolveInfo.loadLabel(localPackageManager)).setIcon(localResolveInfo.loadIcon(localPackageManager)).setOnMenuItemClickListener(this.mOnMenuItemClickListener);
      i += 1;
    }
  }
...
/* Location:              C:\Users\HP\Desktop\Nova pasta\dex2jar-2.0\fiap-dex2jar.jar!\com\actionbarsherlock\widget\ShareActionProvider.class
