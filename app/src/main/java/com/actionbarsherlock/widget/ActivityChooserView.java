  ...
  implements ActivityChooserModel.ActivityChooserModelClient
{
  ...
  public ActivityChooserView(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    this.mInitialActivityCount = paramAttributeSet.getInt(R.styleable.SherlockActivityChooserView_initialActivityCount, 4);
    ...
    public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
    {
      ...
      case 1: 
        ...
        else
        {
          ...
          localView.setId(1);
          ((TextView)localView.findViewById(R.id.abs__title)).setText(ActivityChooserView.this.mContext.getString(R.string.abs__activity_chooser_view_see_all));
        }
        return localView;
      }
      if (paramView != null)
...
/* Location:              C:\Users\HP\Desktop\Nova pasta\dex2jar-2.0\fiap-dex2jar.jar!\com\actionbarsherlock\widget\ActivityChooserView.class
