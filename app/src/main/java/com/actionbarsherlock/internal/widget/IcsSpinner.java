  ...
  implements DialogInterface.OnClickListener
{
  ...
  public IcsSpinner(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    this.mDropDownWidth = localTypedArray.getLayoutDimension(R.styleable.SherlockSpinner_android_dropDownWidth, -2);
    ...
    this.mGravity = localTypedArray.getInt(R.styleable.SherlockSpinner_android_gravity, 17);
    this.mPopup.setPromptText(localTypedArray.getString(R.styleable.SherlockSpinner_android_prompt));
...
/* Location:              C:\Users\HP\Desktop\Nova pasta\dex2jar-2.0\fiap-dex2jar.jar!\com\actionbarsherlock\internal\widget\IcsSpinner.class
