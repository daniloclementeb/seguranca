  ...
  extends NineLinearLayout
{
  ...
  public void setDividerDrawable(Drawable paramDrawable)
  {
    ...
    for (this.mDividerHeight = ((Drawable)localObject).getIntrinsicHeight();; this.mDividerHeight = 0)
    {
      if (localObject == null) {
        bool = true;
      }
...
/* Location:              C:\Users\HP\Desktop\Nova pasta\dex2jar-2.0\fiap-dex2jar.jar!\com\actionbarsherlock\internal\widget\IcsLinearLayout.class
