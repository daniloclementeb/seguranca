  ...
  extends ActionBarSherlock
{
  ...
  protected Context getThemedContext()
  {
    ...
    if (localTypedValue.resourceId != 0) {
      localObject = new ContextThemeWrapper(localActivity, localTypedValue.resourceId);
    }
...
/* Location:              C:\Users\HP\Desktop\Nova pasta\dex2jar-2.0\fiap-dex2jar.jar!\com\actionbarsherlock\internal\ActionBarSherlockNative.class
