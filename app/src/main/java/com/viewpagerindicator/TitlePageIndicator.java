  ...
  implements PageIndicator
{
  ...
  protected void onDraw(Canvas paramCanvas)
  {
    ...
    do
    {
      ...
      Rect localRect = (Rect)((ArrayList)localObject1).get(m);
      Object localObject3;
  ...
  public static enum IndicatorStyle
  {
    ...
    private IndicatorStyle(int paramInt1)
    {
    ...
    public static IndicatorStyle fromValue(int paramInt)
    {
      ...
      for (;;)
      {
        ...
        IndicatorStyle localIndicatorStyle;
        do
        {
          return (IndicatorStyle)localObject;
          localIndicatorStyle = arrayOfIndicatorStyle[i];
          localObject = localIndicatorStyle;
        } while (localIndicatorStyle.value == paramInt);
        i += 1;
      }
    }
  }
  ...
  public static enum LinePosition
  {
    ...
    private LinePosition(int paramInt1)
    {
      this.value = paramInt1;
    }
    ...
    public static LinePosition fromValue(int paramInt)
    {
      ...
      for (;;)
      {
        ...
        LinePosition localLinePosition;
        do
        {
          return (LinePosition)localObject;
          localLinePosition = arrayOfLinePosition[i];
          localObject = localLinePosition;
        } while (localLinePosition.value == paramInt);
        i += 1;
      }
    }
  }
...
/* Location:              C:\Users\HP\Desktop\Nova pasta\dex2jar-2.0\fiap-dex2jar.jar!\com\viewpagerindicator\TitlePageIndicator.class
