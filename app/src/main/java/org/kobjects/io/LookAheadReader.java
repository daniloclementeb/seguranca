  ...
  extends Reader
{
    ...
    throws IOException
  {
    ...
    do
    {
      ...
      paramInt1 = paramInt2;
    } while (this.bufPos <= this.buf.length);
...
/* Location:              C:\Users\HP\Desktop\Nova pasta\dex2jar-2.0\fiap-dex2jar.jar!\org\kobjects\io\LookAheadReader.class
