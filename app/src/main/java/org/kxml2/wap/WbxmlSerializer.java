  ...
  implements XmlSerializer
{
    ...
    if (localObject1 == null)
    {
      ...
      if (j == 0) {
        if (paramBoolean)
        {
          ...
          this.buf.write(3);
          writeStrI(this.buf, (String)this.attributes.elementAt(i));
        }
      }
    }
    for (;;)
    ...
    throws IOException
  {
    this.out.write(3);
    this.out.write(1);
    paramBoolean = new String[2];
    paramBoolean[0] = "UTF-8";
    paramBoolean[1] = "ISO-8859-1";
    if ((paramString == null) || (paramString.toUpperCase().equals(paramBoolean[0])))
    {
      this.encoding = paramBoolean[0];
      this.out.write(106);
      return;
    }
    if (true == paramString.toUpperCase().equals(paramBoolean[1]))
    {
      this.encoding = paramBoolean[1];
      this.out.write(4);
      return;
    }
  ...
  void writeStrT(String paramString)
    throws IOException
  {
    Integer localInteger2 = (Integer)this.stringTable.get(paramString);
    Integer localInteger1 = localInteger2;
    if (localInteger2 == null)
    {
      localInteger1 = new Integer(this.stringTableBuf.size());
      this.stringTable.put(paramString, localInteger1);
      writeStrI(this.stringTableBuf, paramString);
      this.stringTableBuf.flush();
    }
    writeInt(this.buf, localInteger1.intValue());
  }
}


/* Location:              C:\Users\HP\Desktop\Nova pasta\dex2jar-2.0\fiap-dex2jar.jar!\org\kxml2\wap\WbxmlSerializer.class
